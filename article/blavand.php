<?php
$blog = [ 
'meta_desc' => 'Join me on my unforgettable trip to Blåvand, Denmark`s westernmost city. Strolling around the charming city, grabbing a fresh shrimp salad, and marvelling at the towering Blåvand Lighthouse. I walked among the dunes, listened to the North Sea, and explored historic WWII bunkers.',
'meta_keywords' => 'Kolding, Oksbøl, Blåvand, Denmark, Blåvand Lighthouse, Summer Houses, Pine Trees, North Sea Shore, Blåvandshuk, WWII Bunkers, Atlantic Wall, 3D Modeling App, Polycam, Dunes, Star Wars, Amber, Jewelry, Danish Military, Training Grounds, Bjarke Ingels, Tirpitz Museum.',
'title' => 'Blåvand 🇩🇰 ',
'id' =>'blavand',
'date' => 'April 2022',
